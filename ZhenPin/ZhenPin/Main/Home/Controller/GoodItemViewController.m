...
-(void)createUI{
    ...
    SSTScrollView *adSV=[SSTScrollView scrollViewWithFrame:CGRectMake(0, gap, headView.frame.size.width, 300) style:MyScrollViewStyleLabel imgArray:_goodItemM.imgArr titleArr:nil timer:4.5];
    ...
    //
    //
    [GoodItemBottomView createBottomViewWithDelegate:self inView:self.view];
}
